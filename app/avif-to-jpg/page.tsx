...
export default function AvifToJpgPage() {
  return (
    <main className="container-page relative overflow-hidden pb-20 pt-16 sm:pb-32 sm:pt-24">
      {/* Decorative background grid/gradients for a premium SaaS feel */}
      ...
      <div className="pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
        <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-brand-primary/20 to-purple-500/20 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] dark:from-brand-primary/30 dark:to-purple-500/30" />
      </div>
