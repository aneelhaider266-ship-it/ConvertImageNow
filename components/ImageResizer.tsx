...
export const metadata: Metadata = {
  title: "Image Resizer - Resize by Pixels or % Free (No Quality Loss)",
  description:
    "Resize JPG, PNG, WebP, AVIF images online for free. Set exact width & height in pixels or percentage, lock aspect ratio, reduce file size, and batch resize for Instagram, web & print.",
  keywords: [
    "image resizer",
    "resize image online",
