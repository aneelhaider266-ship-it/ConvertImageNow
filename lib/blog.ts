...
export const BLOG_POSTS: BlogPost[] = [
...

  {
    ...
    excerpt:
      "Fix upload rejections fast with a free online image converter JPEG to JPG, batch process locally, no uploads, no account, no watermarks.",
    date: "2026-09-11",
    updatedDate: "2026-09-11",
    canonical:
      "https://www.convertimagenow.com/blog/online-image-converter-jpeg-to-jpg",
    keywords: [
      "convert JPEG to JPG",
...

  {
    ...
    excerpt:
      "You are picking images for a website, an online store, or just trying to shrink a folder of photos, and you keep hitting the same question: jpg vs webp, which one actually wins?",
    date: "2026-09-11",
    updatedDate: "2026-09-11",
